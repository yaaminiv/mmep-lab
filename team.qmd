...
::: {style="display: flow-root; margin-bottom: 10px;"}
...
::: {style="float:right"}
```{r, echo=FALSE, out.width= "350px", out.extra='style="float:right; padding-left:15px; padding-top:15px"'}
...
::: {style="float:left"}
```{r, echo=FALSE, out.width= "350px", out.extra='style="float:left; padding-right:15px; padding-top:15px"'}
knitr::include_graphics("images/Fong_headshot.jpg")
```
:::

## Jasmine Fong

[Lab notebook](https://docs.google.com/document/d/1wN_iivSvqCWL5rO3pwCrz-ZIHvlRv5piEsKXmv2jw5Y/edit?tab=t.tv39a61tolyh#heading=h.35smbuej444m) she/they

LEAP Program funding recipient Summer 2026

I am a second-year Biochemistry major at Santa Clara University. I am interested in research involving genetics and physiology exploring life from the organismal to the molecular level. At the moment, I am focusing on the molecular side of research working with DNA and assays to assess metabolism. Outside of academics, I love exploring new restaurants, baking, painting, and especially watching musicals.
...
**Interested in live animal experiments with marine invertebrates, finessing your molecular bench skills, and/or learning computational data analysis?** Then the MMEP Lab is the place for you! If you would like to work in the MMEP Lab, then fill out [this Google Form](https://forms.gle/Km5jZ212iPfRAADX8) and I will contact you when I have an opening.
