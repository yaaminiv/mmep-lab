...
```{r out.height="5%", echo=FALSE, fig.cap="Simplified food web"}
...
```{r out.width ="50%", echo=FALSE, fig.cap="In the ROV Hercules control van with Amy Smith."}
...
```{r out.width ="40%", echo=FALSE, fig.cap="Sampling microcolonizer experiments on board the EV Nautilus."}
knitr::include_graphics("images/IMG_4779.jpg")
```

```{r out.width ="60%", echo=FALSE, fig.cap="Mt Edwards vent site at Gorda Ridge with microcolonizer experiments."}
...
```{r out.width ="60%", echo=FALSE, fig.cap="SPOT cruise"}
...
```{r out.width ="60%", echo=FALSE, fig.cap="HOT cruise"}
